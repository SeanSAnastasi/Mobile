        ...
        <div className="full-container">
            <div ref={chatArea} className="chat-area">
                ...
                {messages.map((message)=>{
                   ...
                   if(message.sent){
                       return(
                           <div className="message-sent">{message.value}</div>
                       )
                   }else{
                       return(
                            <div className="message-received">{message.value}</div>
                       )
            ...
            <form onSubmit={addMessage}>
                <div className="chat-input-area">
                    ...
                    <input type="text" placeholder="Enter chat message..." name="message" value={placeholder} onChange={handleChange}></input>
