...
function SimpleDialog(props) {
  ...
  return (
    <Dialog onClose={handleClose} aria-labelledby="simple-dialog-title" open={open}>
      <DialogTitle id="simple-dialog-title">Please Login to Continue</DialogTitle>
      <Button className="accessibleButton" variant="contained" style={{color: "white", textDecoration:"none", fontSize: "11px"}} onClick={handleGoogleAuth}>
                    Sign in
        </Button>
    </Dialog>
  );
